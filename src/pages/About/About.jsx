    ...
    <div className="w-full bg-white font-montserrat">
      ...
      <section className="relative w-full h-screen overflow-hidden">
        ...
        <div className="relative z-10 h-1/2 flex flex-col justify-center px-2 pt-20 sm:pt-12 sm:px-4 md:px-[150px]">
          <h1
            className={`text-white text-2xl sm:text-3xl md:text-4xl font-normal uppercase mb-4 sm:mb-6 transition-all duration-700 ${
          ...
          <p
            className={`text-white text-xs sm:text-sm md:text-base leading-5 max-w-full sm:max-w-[543px] capitalize transition-all duration-700 delay-200 ${
              isVisible.hero ? "translate-y-0 opacity-100" : "translate-y-6 opacity-0"
            }`}
          >
      ...
      >
        <div
          className={`w-full md:w-1/2 mb-8 md:mb-0 md:pr-8 pt-44 transition-all duration-700 ${
            isVisible.journey ? "translate-x-0 opacity-100" : "translate-x-[-30px] opacity-0"
          }`}
        >
        ...
        <div
          className={`w-full md:w-1/2 h-[300px] sm:h-[400px] md:h-screen relative transition-all duration-700 delay-200 ${
            isVisible.journey ? "translate-x-0 opacity-100" : "translate-x-[30px] opacity-0"
          }`}
        >
      ...
      >
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
          ...
          <div
            className={`w-full lg:w-1/2 h-[250px] sm:h-[300px] md:h-[500px] lg:h-screen relative transition-all duration-700 ${
              isVisible.handmade ? "translate-x-0 opacity-100" : "translate-x-[-30px] opacity-0"
            }`}
          >
            <img
              src={aboutGrid}
          ...
          <div
            className={`w-full lg:w-1/2 flex flex-col justify-center pt-8 sm:pt-12 md:pt-16 transition-all duration-700 delay-200 ${
              isVisible.handmade ? "translate-x-0 opacity-100" : "translate-x-[30px] opacity-0"
            }`}
          >
            <h2 className="text-3xl md:text-4xl font-medium text-black capitalize mb-6">
      ...
      >
        {/* Intro Text */}
        <p
          className={`text-base md:text-lg font-semibold text-black text-center capitalize mb-12 md:mb-16 max-w-4xl mx-2 md:mx-auto px-0 transition-all duration-700 ${
        ...
        <div className="relative w-full max-w-7xl mx-auto items-end">
          <div className="flex flex-wrap justify-center items-end gap-4 md:gap-6 lg:gap-8">
            ...
            <div
              className={`flex flex-col items-center w-[140px] md:w-[181px] transition-all duration-500 ${
                isVisible.collections ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
              }`}
            ...
            {/* Flower Collection */}
            <div
              className={`flex flex-col items-center w-[140px] md:w-[181px] mt-12 md:mt-20 transition-all duration-500 ${
                isVisible.collections ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
              }`}
            ...
            {/* Festive Collection */}
            <div
              className={`flex flex-col items-end w-[140px] md:w-[181px] mt-12 md:mt-20 transition-all duration-500 ${
                isVisible.collections ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
              }`}
