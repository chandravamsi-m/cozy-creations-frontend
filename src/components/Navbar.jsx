      ...
      <div className="relative max-w-[1280px] mx-auto px-4 py-2">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-10 text-xs text-white uppercase">
            <NavLink to="/" className={({ isActive }) => `hover:text-yellow-accent transition-colors ${isActive ? 'text-yellow-accent' : ''}`}>
              Home
            </NavLink>
            <NavLink to="/about" className={({ isActive }) => `hover:text-yellow-accent transition-colors ${isActive ? 'text-yellow-accent' : ''}`}>
              About Us
            </NavLink>
            <NavLink to="/products" className={({ isActive }) => `hover:text-yellow-accent transition-colors ${isActive ? 'text-yellow-accent' : ''}`}>
              Products
            </NavLink>
            <NavLink to="/custom" className={({ isActive }) => `hover:text-yellow-accent transition-colors ${isActive ? 'text-yellow-accent' : ''}`}>
              Custom
            </NavLink>
          </div>
        ...
        >
          <NavLink onClick={() => setMenuOpen(false)} to="/" className="block hover:text-yellow-accent">Home</NavLink>
